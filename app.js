...
var spagenavTemplate = fs.readFileSync(__dirname + '/views/partials/spagenav.hbs', 'utf8');
hbs.registerPartial('spagenav', spagenavTemplate); 

var spagehTemplate = fs.readFileSync(__dirname + '/views/partials/spageh.hbs', 'utf8');
hbs.registerPartial('spageh', spagehTemplate); 

var spagefTemplate = fs.readFileSync(__dirname + '/views/partials/spagef.hbs', 'utf8');
hbs.registerPartial('spagef', spagefTemplate); 
